...
class TeachingAssistantWorkflow:
    def __init__(self):
        ...
        workflow_builder.add_node("brain_node", TeachingAssistantAgent.run_llm())
        workflow_builder.add_node("action_node",TeachingAssistantAgent.tool_node())
